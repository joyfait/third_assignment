...
#Q1
## DOWNLOAD THE CODING SEQUENCES OF E.COLI AND CAMPYLOBACTER COLI.HOW MANY CODING SEQUENCE ARE PRESENT IN THESE ORGANISMS? HOW MUCH CODING DNA IS THERE IN TOTAL FOR THESE TWO ORGANISMS? DESCRIBE ANY DIFFERENCES BETWEEN THE TWO ORGANISMS.
```{r}
library("R.utils")
...
```{r}
dna <- unlist(cds) #for Ecoli
dna1 <- unlist(cds1) # for Ccoli
```
...
```{r}
translate(cds[[1]]) # to calculate the total protein sequence, first translate
