...
```{r}
boxplot(len, ylab="LENGTH OF SEQUENCE (bp)", main= "BOXPLOT SHOWING THE LENGTH CODING SEQUENCE IN E.coli")

boxplot(len1, ylab= "LENGTH OF SEQUENCE (bp)", main= "BOXPLOT SHOWING THE LENGTH CODING SEQUENCE IN Campylobacter coli") 
```
